...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var starter1, starter2, main1, main2, dessert1, drink1, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.menuItem.create({
                        data: {
                            name: 'Bruschetta',
                ...
                case 9:
                    ...
                    return [3 /*break*/, 7];
                case 10:
                    console.log({ starter1: starter1, starter2: starter2, main1: main1, main2: main2, dessert1: dessert1, drink1: drink1 });
                    return [2 /*return*/];
            }
        });
    });
